...
#import "CCMyASIHTTPRequestConfig.h"

typedef enum _CCMyASIPostFormat {
    ASIMultipartFormDataPostFormat = 0,
    ASIURLEncodedPostFormat = 1
	
} CCMyASIPostFormat;

@interface CCMyASIFormDataRequest : CCMyASIHTTPRequest <NSCopying> {
...
@property (atomic, assign) CCMyASIPostFormat postFormat;
