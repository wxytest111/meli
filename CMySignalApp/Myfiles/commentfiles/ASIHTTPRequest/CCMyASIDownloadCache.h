...
#import "CCMyASICacheDelegate.h"

@interface CCMyASIDownloadCache : NSObject <CCMyASICacheDelegate> {
...
// Returns a static instance of an CCMyASIDownloadCache
// In most circumstances, it will make sense to use this as a global cache, rather than creating your own cache
// To make ASIHTTPRequests use it automatically, use [ASIHTTPRequest setDefaultCache:[CCMyASIDownloadCache sharedCache]];
+ (id)sharedCache;
...
@property (assign, nonatomic) CCMyASICachePolicy defaultCachePolicy;
