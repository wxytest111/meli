...
#import "CCMyASIHTTPRequestDelegate.h"
#import "CCMyASIProgressDelegate.h"

@interface CCMyASINetworkQueue : NSOperationQueue <CCMyASIProgressDelegate, CCMyASIHTTPRequestDelegate, NSCopying> {
