...
@interface CCMyASIInputStream : NSObject {
	NSInputStream *stream;
	CCMyASIHTTPRequest *request;
}
+ (id)inputStreamWithFileAtPath:(NSString *)path request:(CCMyASIHTTPRequest *)request;
+ (id)inputStreamWithData:(NSData *)data request:(CCMyASIHTTPRequest *)request;

@property (retain, nonatomic) NSInputStream *stream;
@property (assign, nonatomic) CCMyASIHTTPRequest *request;
@end
