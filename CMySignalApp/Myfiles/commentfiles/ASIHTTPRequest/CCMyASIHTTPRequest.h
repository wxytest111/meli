...
@class CCMyASIDataDecompressor;

extern NSString *CCMyASIHTTPRequestVersion;
...
typedef enum _CCMyASIAuthenticationState {
	ASINoAuthenticationNeededYet = 0,
	ASIHTTPAuthenticationNeeded = 1,
	ASIProxyAuthenticationNeeded = 2
} CCMyASIAuthenticationState;

typedef enum _CCMyASINetworkErrorType {
...
} CCMyASINetworkErrorType;


// The error domain that all errors generated by ASIHTTPRequest use
extern NSString* const CCMyNetworkRequestErrorDomain;
...
extern unsigned long const CCMyASIWWANBandwidthThrottleAmount;
...
@interface CCMyASIHTTPRequest : NSOperation <NSCopying> {
	...
	id <CCMyASIHTTPRequestDelegate> delegate;
	...
	id <CCMyASIHTTPRequestDelegate, CCMyASIProgressDelegate> queue;
	...
	id <CCMyASIProgressDelegate> uploadProgressDelegate;
	...
	id <CCMyASIProgressDelegate> downloadProgressDelegate;
	...
	CCMyASIHTTPRequest *mainRequest;
	...
	// See CCMyASIAuthenticationState values above. 0 == default == No authentication needed yet
	CCMyASIAuthenticationState authenticationNeeded;
	...
	CCMyASIDataDecompressor *dataDecompressor;
	...
	CCMyASIHTTPRequest *PACFileRequest;
...
@property (atomic, assign) CCMyASIHTTPRequest *mainRequest;
...
@property (atomic, assign, readonly) CCMyASIAuthenticationState authenticationNeeded;
...
@property (atomic, assign) id <CCMyASICacheDelegate> downloadCache;
@property (atomic, assign) CCMyASICachePolicy cachePolicy;
@property (atomic, assign) CCMyASICacheStoragePolicy cacheStoragePolicy;
...
#endif
@property (atomic, retain) CCMyASIDataDecompressor *dataDecompressor;
